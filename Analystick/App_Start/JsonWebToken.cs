...
namespace Analystick.Web
{
    public static class JsonWebToken
    {
        ...
        private static readonly string[] claimTypesForUserName = {"name", "email", "user_id", "sub"};
        ...
        {
            string payloadJson = JWT.JsonWebToken.Decode(token, Convert.FromBase64String(secretKey), verify: true);
        ...
        private static ClaimsIdentity ClaimsIdentityFromJwt(IDictionary<string, object> jwtData, string issuer)
        {
            ...
            List<Claim> claims = ClaimsFromJwt(jwtData, issuer);
